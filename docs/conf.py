# -*- coding: utf-8 -*-
#
# template CMS Guide documentation build configuration file, created by
...
man_pages = [
    ('index', 'templatecmsguide', u'template Documentation',
...
texinfo_documents = [
  ('index', 'templateCMSGuide', u'template Documentation',
   u'Christopher Clarke', 'templateCMSGuide', 'One line description of project.',
   'Miscellaneous'),
]
